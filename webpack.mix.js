...
const paths = {
    ...
    'smalotDatepicker': vendors + 'bootstrap-datetime-picker/',
...
//ionicons
mix.copy(paths.ionicons + 'dist/css/ionicons.min.css', destVendors + 'ionicons/css');
mix.copy(paths.ionicons + 'dist/fonts', destVendors + 'ionicons/fonts');

// Copy fonts straight to public
mix.copy(paths.bootstrap + 'fonts', destFonts);
mix.copy(paths.fontawesome + 'webfonts',destFonts);
mix.copy(paths.ionicons + 'dist/fonts', destFonts);
...
//fancybox
mix.copy(paths.fancybox + '/dist',  destVendors + 'fancybox');
...
mix.copy(paths.sortable + 'Sortable.js',  destVendors + 'sortablejs/js');
...
// font-awesome
mix.copy(paths.fontawesome + 'css/fontawesome.min.css', 'public/assets/css');
mix.copy(paths.fontawesome + 'css/all.css', 'public/assets/css');
...
mix.copy(paths.card + 'lib/',  destVendors + 'card/lib/js');
// mix.copy(paths.card + 'src',  destVendors + 'card');
mix.copy(paths.card + 'dist/jquery.card.js',  destVendors + 'card/lib/js');
...
mix.copy(paths.html5sortable + 'html5sortable.js',  destVendors + 'html5sortable/html.sortable.js');
...
mix.combine(
    [
        ...
        vendors + 'components-jqueryui/jquery-ui.min.js',
