...
class AuthController extends JoshController
{
    ...
    public function getLogout()
    {
        ...
        if (Sentinel::check()) {
            ...
            return redirect('1m93fLGAHMX8E16Ycruzfi1d6df9cjH9i/signin')->with('success', 'You have successfully logged out!');
        } else {

        // Redirect to the users page
            return redirect('1m93fLGAHMX8E16Ycruzfi1d6df9cjH9i/signin')->with('error', 'You must be login!');
        }
    }
